...
const Blog = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Industry Insights & Digital Marketing Blog | SonBarsa</title>
        <meta
          name="description"
          content="Expert insights on digital marketing, web development, cloud computing, and business growth. Stay updated with the latest industry trends and strategies."
        />
        <meta
          name="keywords"
          content="digital marketing blog, web development tips, AWS cloud guides, SEO strategies, social media marketing, e-commerce optimization"
        />
        <link rel="canonical" href="https://sonbarsa.com/blog" />
        <meta property="og:title" content="Industry Insights & Digital Marketing Blog | SonBarsa" />
        <meta property="og:description" content="Expert insights on digital marketing, web development, cloud computing, and business growth strategies." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://sonbarsa.com/blog" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Industry Insights & Digital Marketing Blog | SonBarsa" />
        <meta name="twitter:description" content="Expert insights on digital marketing, web development, cloud computing, and business growth strategies." />
        <script type="application/ld+json">
          {JSON.stringify({
            "@context": "https://schema.org",
            "@type": "Blog",
            "name": "SonBarsa Industry Insights",
            "url": "https://sonbarsa.com/blog",
            "description": "Expert insights on AI, machine learning, generative AI, cloud, web development, and digital marketing.",
            "publisher": {
              "@id": "https://sonbarsa.com/#organization",
              "@type": "Organization",
              "name": "SonBarsa",
